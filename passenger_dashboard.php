...
// Check if the user is logged in and has the 'passenger_dashboard' role
if (!isset($_SESSION['user']) || $_SESSION['role'] != 'passenger') {
    // Redirect to login page if not logged in or not an passenger_dashboard
    header("Location: login.php");
    exit();
}
// Hubi in passenger_id la kaydiyay si aan error uga fogaanno
if (!isset($_SESSION['user_id'])) {
    echo "<div class='alert alert-danger'>Error: Passenger ID not set in session.</div>";
    exit();
}
...
// 1. Tirada Bookings uu sameeyey rakaabka
$totalMyBookings = $conn->query("SELECT COUNT(*) FROM bookings WHERE passenger_id = $passenger_id")->fetch_row()[0];

// 2. Tirada Payments ee uu sameeyey rakaabkan
$queryPayments = "
    SELECT COUNT(*) 
    FROM payments 
    WHERE booking_id IN (
        SELECT booking_id FROM bookings WHERE passenger_id = $passenger_id
    )";
$totalMyPayments = $conn->query($queryPayments)->fetch_row()[0];

// 3. Tirada Tickets uu helay rakaabka
$queryTickets = "
    SELECT COUNT(*) 
    FROM tickets 
    WHERE booking_id IN (
...
$totalMyTickets = $conn->query($queryTickets)->fetch_row()[0];
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                <h5>My Bookings</h5>
                                <h3><?php echo $totalMyBookings; ?></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card text-white bg-success">
                            <div class="card-body">
                                <h5>My Payments</h5>
                                <h3><?php echo $totalMyPayments; ?></h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2026 Concept. All rights reserved. Dashboard by <a href="https://colorlib.com/wp/">Colorlib</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
